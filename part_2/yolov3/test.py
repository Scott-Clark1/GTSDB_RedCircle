...
def test(
    ...
    for batch_i, (imgs, targets, paths, shapes) in enumerate(dataloader):
        ...
        for si, (labels, detections) in enumerate(zip(targets, output)):
            ...
            test_var_scott = np.bincount(AP_class, minlength=nC)
            #print(test_var_scott.shape)
            AP_accum_count += test_var_scott
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-cfg', type=str, default='cfg/rc.data', help='coco.data file path')
