...
class LoadImagesAndLabels:  # for training
    ...
    def __next__(self):
        ...
        for index, files_index in enumerate(range(ia, ib)):
            ...
            if self.augment:
                img, labels, M = random_affine(img, labels, degrees=(-25, 25), translate=(0.10, 0.10), scale=(0.80, 1.20))
...
def random_affine(img, targets=None, degrees=(-30, 30), translate=(.1, .1), scale=(.8, 1.2), shear=(-2, 2),
